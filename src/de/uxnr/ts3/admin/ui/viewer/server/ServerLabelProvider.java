...
public class ServerLabelProvider extends LabelProvider implements ITableLabelProvider {
  ...
  public Image getColumnImage(Object element, int columnIndex) {
    ...
    switch (columnIndex) {
      case 3:
        return new IconDescriptor(server.getStatus().equals("online") ? "server_go" : "server")
            .createImage();
      case 7:
  ...
  public String getColumnText(Object element, int columnIndex) {
    ...
    switch (columnIndex) {
      ...
      case 4:
        return String.valueOf(server.getClientsOnline()) + " / "
            + String.valueOf(server.getMaxClients());
      case 5:
